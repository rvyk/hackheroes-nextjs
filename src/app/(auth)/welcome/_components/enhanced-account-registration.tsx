...
export function EnhancedAccountRegistrationComponent() {
  ...
  const handleComplete = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Po zarejestrowaniu można przekierować użytkownika lub pokazać komunikat sukcesu
    }, 2000);
  };
  ...
  const renderContent = () => {
    switch (step) {
      case 1:
        return (
          <motion.div key="user-type" {...slideAnimation}>
            <CardHeader>
      ...
      case 2:
        return (
          <motion.div key="facility-data" {...slideAnimation}>
            <CardHeader>
              <CardTitle className="flex items-center justify-center text-2xl font-bold text-green-800">
